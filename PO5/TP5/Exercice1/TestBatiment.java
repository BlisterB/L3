class TestBatiment{
	...
	public static void main(String[] arg){
		Batiment batiment = new Batiment("1 Rue du Tardis", 40);
		Maison maison = new Maison("15ter rue Jean Coquelin", 100, 20, 4);
		Immeuble immeuble = new Immeuble("20 Rue General Leclerc", 200, 8);
